...
def getSentiments(userText, type):
    if(type == 'Positive/Negative/Neutral - TextBlob'):
        ...
        if(status=="Positive"):
            image = Image.open(r'D:\OneDrive\Desktop\Sentiment-Analysis-website-main\images\positive.PNG')
        elif(status == "Negative"):
            image = Image.open(r'D:\OneDrive\Desktop\Sentiment-Analysis-website-main\images\negative.PNG')
        else:
            image = Image.open(r'D:\OneDrive\Desktop\Sentiment-Analysis-website-main\images\neutral.PNG')
...
def renderPage():
    st.title("Sentiment Analysis 😊😐😕😡 Made By Abdulrahman And Selman")
